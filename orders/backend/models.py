...
class ProductInfo(models.Model):
    ...
    product = models.ForeignKey(Product, related_name='product_info', on_delete=models.CASCADE, null=True, blank=True,
                                verbose_name='Продукт')
    shop = models.ForeignKey(Shop, related_name='product_info', on_delete=models.CASCADE, null=True, blank=True,
                             verbose_name='Магазин')
    ...
    class Meta:
        ...
        constraints = [
            models.UniqueConstraint(fields=['product', 'model', 'shop', 'external_id'], name='unique_product_info')]
...
class ProductParameter(models.Model):
    ...
    product_info = models.ForeignKey(ProductInfo, related_name='product_parameters', on_delete=models.CASCADE,
                                     null=True, blank=True, verbose_name='Информация о продукте')
    parameter = models.ForeignKey(Parameter, related_name='product_parameters', on_delete=models.CASCADE, null=True,
...
class OrderItem(models.Model):
    ...
    product_info = models.ForeignKey(ProductInfo, related_name='order_items', on_delete=models.CASCADE, null=True,
                                     blank=True, verbose_name='Информация о продукте')
    quantity = models.PositiveIntegerField(verbose_name='Количество')
